...
import 'package:app_movil_dincydet/providers/manage_docs/doc_transmitted_provider.dart';
...
class DocumentTransmittedPage extends StatelessWidget {
  const DocumentTransmittedPage({super.key});
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => DocumentTransmittedProvider(),
      child: Consumer<DocumentTransmittedProvider>(
        builder: (context, provider, child) {
          return MyScaffold(
            title: 'Documentos Transmitidos',
            section: DrawerSection.docstransmitted,
            drawer: true,
            body: Padding(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: DropdownButtonFormField<int>(
                                    ...
                                    isExpanded: true,
                                    items: List.generate(
                                        documentManagementTypes.length,
                                        (index) {
                                      return DropdownMenuItem(
                                        value: index,
                                        child: Text(
                                            documentManagementTypes[index]),
                                      );
                                    }),
