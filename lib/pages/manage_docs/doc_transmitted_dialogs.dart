...
class DocumentTransmittedNewDialog extends StatefulWidget {
  DocumentTransmittedNewDialog({super.key});

  DocumentTransmittedNewDialog.edit({
    super.key,
  ...
  @override
  State<DocumentTransmittedNewDialog> createState() =>
      _DocumentTransmittedNewDialogState();
}

class _DocumentTransmittedNewDialogState
    extends State<DocumentTransmittedNewDialog> {
  ...
  Widget build(BuildContext context) {
    return SimpleDialog(
      ...
      title: Container(
        ...
        child: Text(
          '${widget.editMode ? 'Editar' : 'Registrar'} Documento Transmitido',
  ...
  void onTapSave() async {
    ...
    if (widget.editMode) {
      ...
      final response = await apiDocumentTransmittedNew(dataMap);
      if (response == null) return;
    }
...
class DocumentTransmittedViewDialog extends StatelessWidget {
  const DocumentTransmittedViewDialog({
    super.key,
    required this.data,
